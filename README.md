...
## ONETEAM 이 만드는 ONETT(One Trendy Time) - 이종표,이혜선,임재영,조훈 <img src="https://img.shields.io/badge/MySQL-바탕색?style=flat&logo=SQL&logoColor=white"/> <img src="https://img.shields.io/badge/Redis-바탕색?style=flat&logo=Redis&logoColor=red"/>
...
# 🤗프로젝트
# 개념적 모델링
<img src="https://github.com/hyesunlee30/data_modeling_1team/blob/main/data_modeling/ERD/final_onett.drawio.png?raw=true"/>
...
# 프로젝트 관리
# WBS
[WBS](https://docs.google.com/spreadsheets/d/18YNMnxvCihb60FS0_cGEvzS2jzDiq4Dp/edit#gid=1057334268)
...
<br/>
# JIRA
[Jira](https://hyesun.atlassian.net/jira/software/projects/ON/boards/1?selectedIssue=ON-38)
...
조훈 "서비스구축부터 DB까지 직접 작성해보니 개발에 대한 대략적인 뼈대가 잡힌 것 같아 보람찬 시간이였습니다" <br/>
임재영 "" <br/>
이종표 "" <br/>
